...
export class HostGattDescriptor extends BaseHostInterface {
    ...
    constructor(bluez: Bluez, characteristic: HostGattCharacteristic, uuid: string, flags = [], index = 0) {
        super(bluez,
            HostGattDescriptor.GetPath(characteristic, index),
            `org.bluez.GattDescriptor1`, {
            'Characteristic': { signature: 'o', value: characteristic, valueTransform: (val) => val.path },
