...
export class GattService extends BaseInterface<GattService1> {
   ...
   */
  private constructor(bluez: Bluez, internal: GattService1) {
  ...
  async getCharacteristic(
    filter: InterfaceFilterSet<GattCharacteristic> = {},
    options?: RetryOptions
  ): Promise<GattCharacteristic | undefined> {
    return this.getChildObject(
      "GattCharacteristic1",
      GattCharacteristic.connect,
      filter,
      options
    );
  }
