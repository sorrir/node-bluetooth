...
export class LEAdvertisingManager1 extends EventEmitter {
    ...
    constructor(dbusObject) {
        super();
        this.dbusInterfaceName = 'org.bluez.LEAdvertisingManager1';
    ...
    ActiveInstances() {
        return this.propertiesDBusInterface.Get(this.dbusInterfaceName, 'ActiveInstances').then((variant) => variant.value);
    }

    //@property({ name: 'SupportedInstances', signature: 'y', access: ACCESS_READ })
    SupportedInstances() {
        return this.propertiesDBusInterface.Get(this.dbusInterfaceName, 'SupportedInstances').then((variant) => variant.value);
    }

    //@property({ name: 'SupportedIncludes', signature: 'as', access: ACCESS_READ })
    SupportedIncludes() {
        return this.propertiesDBusInterface.Get(this.dbusInterfaceName, 'SupportedIncludes').then((variant) => variant.value);
    }

    //@property({ name: 'SupportedSecondaryChannels', signature: 'as', access: ACCESS_READ })
    SupportedSecondaryChannels() {
        return this.propertiesDBusInterface.Get(this.dbusInterfaceName, 'SupportedSecondaryChannels').then((variant) => variant.value);
    }
