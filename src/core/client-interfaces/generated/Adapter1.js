...
export class Adapter1 extends EventEmitter {
    ...
    Powered(value) {
        if(value !== undefined) {
            ...
            return this.propertiesDBusInterface.Get(this.dbusInterfaceName, 'Powered').then((variant) => variant.value);
        }
    }
    ...
    Discoverable(value) {
        if(value !== undefined) {
            ...
            return this.propertiesDBusInterface.Get(this.dbusInterfaceName, 'Discoverable').then((variant) => variant.value);
        }
    }
    ...
    DiscoverableTimeout(value) {
        if(value !== undefined) {
            ...
            return this.propertiesDBusInterface.Get(this.dbusInterfaceName, 'DiscoverableTimeout').then((variant) => variant.value);
        }
    }
    ...
    Pairable(value) {
        if(value !== undefined) {
            ...
            return this.propertiesDBusInterface.Get(this.dbusInterfaceName, 'Pairable').then((variant) => variant.value);
        }
    }
    ...
    PairableTimeout(value) {
        if(value !== undefined) {
            ...
            return this.propertiesDBusInterface.Get(this.dbusInterfaceName, 'PairableTimeout').then((variant) => variant.value);
        }
    }

    //@property({ name: 'Discovering', signature: 'b', access: ACCESS_READ })
    Discovering() {
        return this.propertiesDBusInterface.Get(this.dbusInterfaceName, 'Discovering').then((variant) => variant.value);
    }
