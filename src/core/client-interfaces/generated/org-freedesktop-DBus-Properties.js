...
export class OrgfreedesktopDBusProperties extends EventEmitter {
    ...
    constructor(dbusObject) {
        ...
        this.thisDBusInterface = dbusObject.getInterface('org.freedesktop.DBus.Properties');
    ...
    Get(interface, name, ) {
        return this.thisDBusInterface.Get(interface, name, );
    }

    //@method({ name: 'Set', inSignature: 'ssv', outSignature: '' })
    Set(interface, name, value) {
        return this.thisDBusInterface.Set(interface, name, value);
    }

    //@method({ name: 'GetAll', inSignature: 's', outSignature: 'a{sv}' })
    GetAll(interface, ) {
        return this.thisDBusInterface.GetAll(interface, );
    }
