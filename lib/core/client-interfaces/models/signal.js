...
var Signal = /*#__PURE__*/function (_DBusEventEmitter) {
  (0, _inherits2["default"])(Signal, _DBusEventEmitter);

  var _super = _createSuper(Signal);

  function Signal(event, eventEmitter, keyProvider) {
  ...
  return Signal;
}(_dbusEventEmitter.DBusEventEmitter);
