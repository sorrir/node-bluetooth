...
var BaseInterface = /*#__PURE__*/function () {
  function BaseInterface(bluez, internal) {
    ...
    var generatedDBusObject = internal;
    this.path = generatedDBusObject.dbusObject.path;
    this.Properties = new _dbusProperties.DBusProperties(generatedDBusObject.dbusInterfaceName, generatedDBusObject.propertiesDBusInterface);
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                retryOptions = _args2.length > 3 && _args2[3] !== undefined ? _args2[3] : {
                  maxRetries: 0,
              ...
              case 23:
                ...
                _context2.next = 26;
                return (0, _helper.sleep)(retryOptions.retryIntervalMs);

              case 26:
                retryOptions.maxRetries--;
                return _context2.abrupt("return", this.getChildObject(interfaceName, constructor, filter, retryOptions));
