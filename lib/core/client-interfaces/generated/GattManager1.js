...
var GattManager1 = /*#__PURE__*/function (_EventEmitter) {
  (0, _inherits2["default"])(GattManager1, _EventEmitter);

  var _super = _createSuper(GattManager1);

  (0, _createClass2["default"])(GattManager1, null, [{
    key: "Connect",
    value: function Connect(bus, objectPath, xml) {
      ...
      return bus.getProxyObject('org.bluez', objectPath, xml).then(function (obj) {
        return new GattManager1(obj);
      });
    }
  }]);

  function GattManager1(dbusObject) {
    var _this;

    (0, _classCallCheck2["default"])(this, GattManager1);
    _this = _super.call(this);
    _this.dbusInterfaceName = 'org.bluez.GattManager1';
    _this.dbusObject = dbusObject;
    _this.thisDBusInterface = dbusObject.getInterface('org.bluez.GattManager1');
  ...
  (0, _createClass2["default"])(GattManager1, [{
    key: "getProperties",
    ...
    value: function RegisterApplication(application, options) {
    ...
    value: function UnregisterApplication(application) {
...
exports.GattManager1 = GattManager1;