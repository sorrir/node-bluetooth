...
exports.ProfileManager1 = void 0;
...
var ProfileManager1 = /*#__PURE__*/function (_EventEmitter) {
  (0, _inherits2["default"])(ProfileManager1, _EventEmitter);

  var _super = _createSuper(ProfileManager1);

  (0, _createClass2["default"])(ProfileManager1, null, [{
    key: "Connect",
    value: function Connect(bus, objectPath, xml) {
      ...
      return bus.getProxyObject('org.bluez', objectPath, xml).then(function (obj) {
        return new ProfileManager1(obj);
      });
    }
  }]);

  function ProfileManager1(dbusObject) {
    var _this;

    (0, _classCallCheck2["default"])(this, ProfileManager1);
    _this = _super.call(this);
    _this.dbusInterfaceName = 'org.bluez.ProfileManager1';
    _this.dbusObject = dbusObject;
    _this.thisDBusInterface = dbusObject.getInterface('org.bluez.ProfileManager1');
  ...
  (0, _createClass2["default"])(ProfileManager1, [{
    key: "getProperties",
    ...
    key: "RegisterProfile",
    value: function RegisterProfile(profile, UUID, options) {
    ...
    value: function UnregisterProfile(profile) {
      return this.thisDBusInterface.UnregisterProfile(profile);
    }
    /***** Signals for org.bluez.ProfileManager1 *****/

  }]);
  return ProfileManager1;
}(EventEmitter);

exports.ProfileManager1 = ProfileManager1;