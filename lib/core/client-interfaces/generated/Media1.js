...
var Media1 = /*#__PURE__*/function (_EventEmitter) {
  (0, _inherits2["default"])(Media1, _EventEmitter);

  var _super = _createSuper(Media1);

  (0, _createClass2["default"])(Media1, null, [{
    key: "Connect",
    value: function Connect(bus, objectPath, xml) {
      ...
      return bus.getProxyObject('org.bluez', objectPath, xml).then(function (obj) {
        return new Media1(obj);
      });
    }
  }]);

  function Media1(dbusObject) {
    var _this;

    (0, _classCallCheck2["default"])(this, Media1);
    _this = _super.call(this);
    _this.dbusInterfaceName = 'org.bluez.Media1';
    _this.dbusObject = dbusObject;
    _this.thisDBusInterface = dbusObject.getInterface('org.bluez.Media1');
  ...
  (0, _createClass2["default"])(Media1, [{
    key: "getProperties",
    ...
    value: function RegisterEndpoint(endpoint, properties) {
    ...
    key: "RegisterPlayer",
    value: function RegisterPlayer(player, properties) {
