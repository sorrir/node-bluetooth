...
exports.HostGattDescriptor = void 0;
...
var HostGattDescriptor = _decorate(null, function (_initialize, _BaseHostInterface) {
  var HostGattDescriptor = /*#__PURE__*/function (_BaseHostInterface2) {
    (0, _inherits2["default"])(HostGattDescriptor, _BaseHostInterface2);

    var _super = _createSuper(HostGattDescriptor);

    function HostGattDescriptor(bluez, characteristic, uuid) {
      var _this;

      var flags = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : [];
      var index = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : 0;
      (0, _classCallCheck2["default"])(this, HostGattDescriptor);
      _this = _super.call(this, bluez, HostGattDescriptor.GetPath(characteristic, index), "org.bluez.GattDescriptor1", {
        'Characteristic': {
          signature: 'o',
    ...
    return HostGattDescriptor;
  }(_BaseHostInterface);

  return {
    F: HostGattDescriptor,
    d: [{
      kind: "field",
      key: "UUID",
      value: void 0
      ...
      "static": true,
      key: "GetPath",
      value: function GetPath(characteristic, index) {
        return "".concat(characteristic.path, "/desc").concat(index);
      }
    }, {
      kind: "method",
      decorators: [method({
...
exports.HostGattDescriptor = HostGattDescriptor;