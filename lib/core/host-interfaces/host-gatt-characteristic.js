...
exports.HostGattCharacteristic = void 0;
...
var HostGattCharacteristic = _decorate(null, function (_initialize, _BaseHostInterface) {
  var HostGattCharacteristic = /*#__PURE__*/function (_BaseHostInterface2) {
    (0, _inherits2["default"])(HostGattCharacteristic, _BaseHostInterface2);

    var _super = _createSuper(HostGattCharacteristic);

    function HostGattCharacteristic(bluez, service, uuid) {
      var _this;

      var flags = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : [];
      var index = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : 0;
      (0, _classCallCheck2["default"])(this, HostGattCharacteristic);
      _this = _super.call(this, bluez, HostGattCharacteristic.GetPath(service, index), "org.bluez.GattCharacteristic1", {
        'Service': {
          signature: 'o',
          value: service,
        ...
        'UUID': new _types.Variant('s', uuid),
        'Flags': new _types.Variant('as', flags),
        'Descriptors': {
          signature: 'ao',
          value: {},
          valueTransform: function valueTransform(val) {
    ...
    return HostGattCharacteristic;
  }(_BaseHostInterface);

  return {
    F: HostGattCharacteristic,
    d: [{
      kind: "field",
      key: "UUID",
      value: void 0
      ...
      "static": true,
      key: "GetPath",
      value: function GetPath(service, index) {
        return "".concat(service.path, "/char").concat(index);
      }
    }, {
      kind: "method",
      decorators: [method({
      ...
      key: "ReadValue",
      value: function ReadValue(value, options) {
        console.log("".concat(this.path, ":ReadValue"));
      }
    }, {
      kind: "method",
      decorators: [method({
      ...
      value: function WriteValue(value, options) {
        console.log("".concat(this.path, ":WriteValue"));
      ...
      value: function StartNotify() {
        console.log("".concat(this.path, ":StartNotify"));
      }
    }, {
      kind: "method",
      decorators: [method({
      ...
      value: function StopNotify() {
        console.log("".concat(this.path, ":StopNotify"));
      }
    }, {
      kind: "method",
      key: "addDescriptor",
      value: function addDescriptor(uuid) {
        var flags = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : [];
        var index = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 0;
        var descriptor = new _hostGattDescriptor.HostGattDescriptor(this.bluez, this, uuid, flags, index);
      ...
      value: function removeCharacteristic() {
        var index = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 0;

        var path = _hostGattDescriptor.HostGattDescriptor.GetPath(this, index);
...
exports.HostGattCharacteristic = HostGattCharacteristic;