...
exports.UartRxCharacteristic = void 0;
...
var UartRxCharacteristic = _decorate(null, function (_initialize, _HostGattCharacterist) {
  var UartRxCharacteristic = /*#__PURE__*/function (_HostGattCharacterist2) {
    (0, _inherits2["default"])(UartRxCharacteristic, _HostGattCharacterist2);

    var _super = _createSuper(UartRxCharacteristic);

    function UartRxCharacteristic(bluez, service, index) {
      var _this;

      (0, _classCallCheck2["default"])(this, UartRxCharacteristic);
      _this = _super.call(this, bluez, service, RX_CHAR_UUID, ['write'], index);
  ...
  return {
    ...
    d: [{
      ...
      value: function WriteValue(value, options) {
        var message = Buffer.from(value).toString();
        this.onMessage(message, options);
      }
    }, {
      kind: "method",
      key: "onMessage",
      value: function onMessage(message, options) {
        console.log(message);
      }
    }]
  };
...
exports.UartRxCharacteristic = UartRxCharacteristic;