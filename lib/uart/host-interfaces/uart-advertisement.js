...
exports.UartAdvertisement = void 0;
...
var _baseHostInterface = require("../../core/host-interfaces/models/base-host-interface");
...
var UartAdvertisement = _decorate(null, function (_initialize, _BaseHostInterface) {
  var UartAdvertisement = /*#__PURE__*/function (_BaseHostInterface2) {
    (0, _inherits2["default"])(UartAdvertisement, _BaseHostInterface2);

    var _super = _createSuper(UartAdvertisement);

    function UartAdvertisement(bluez, name) {
      var _this;

      var index = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 0;
      (0, _classCallCheck2["default"])(this, UartAdvertisement);
      _this = _super.call(this, bluez, "/org/bluez/sorrir/advertisement".concat(index), "org.bluez.LEAdvertisement1", {
        'LocalName': new _types.Variant('s', name),
        'ServiceUUIDs': new _types.Variant('as', ['6e400001-b5a3-f393-e0a9-e50e24dcca9e']),
        'Includes': new _types.Variant('as', ["tx-power"]),
        'Type': new _types.Variant('s', 'peripheral')
      });
...
exports.UartAdvertisement = UartAdvertisement;