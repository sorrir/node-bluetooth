...
exports.UartTxCharacteristic = void 0;
...
var _hostGattCharacteristic = require("../../core/host-interfaces/host-gatt-characteristic");
...
var UartTxCharacteristic = _decorate(null, function (_initialize, _HostGattCharacterist) {
  var UartTxCharacteristic = /*#__PURE__*/function (_HostGattCharacterist2) {
    (0, _inherits2["default"])(UartTxCharacteristic, _HostGattCharacterist2);

    var _super = _createSuper(UartTxCharacteristic);

    function UartTxCharacteristic(bluez, service, index) {
      var _this;

      (0, _classCallCheck2["default"])(this, UartTxCharacteristic);
      _this = _super.call(this, bluez, service, TX_CHAR_UUID, ['notify'], index);
  ...
  }(_HostGattCharacterist);

  return {
    F: UartTxCharacteristic,
    d: [{
      kind: "field",
      key: "notifying",
      value: void 0
      ...
      value: function sendMessage(message) {
        if (!this.notifying) {
          throw new _handlebars.Exception("Not notifying!");
        }

        this.emitPropertiesChanged({
          'Value': new _types.Variant('ay', (0, _toConsumableArray2["default"])(Buffer.from(message)))
        });
      }
    }]
  };
}, _hostGattCharacteristic.HostGattCharacteristic);

exports.UartTxCharacteristic = UartTxCharacteristic;